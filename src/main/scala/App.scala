...
object App {
  def main(array: Array[String]): Unit = {
    ...
    val users = Seq(
      ...
      Row(4, 4, "Макаров С.С.", Date.valueOf("1993-06-01"), Date.valueOf("2019-09-01")),
      ...
      Row(8, 8, "Миронов С.А.", Date.valueOf("1999-03-21"), Date.valueOf("2019-09-01")),
      ...
      Row(11, 11, "Дагбаев П.Н.", Date.valueOf("1995-03-01"), Date.valueOf("2019-09-01")),
